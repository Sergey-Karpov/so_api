...
- **API URL**: `https://sales-prediction-api.onrender.com`
- **Документация**: `https://sales-prediction-api.onrender.com/docs`
- **Health check**: `https://sales-prediction-api.onrender.com/health`
